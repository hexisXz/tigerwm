...
void tile() {
	...
	int y, x, num_windows;
		...
		for(c=head->next;c;c=c->next) ++num_windows;
		for(c=head->next;c;c=c->next) {
		    XMoveResizeWindow(dis,c->win,x,y,(sw/num_windows)-2*border_space,tile_width);                                                                                                                 x += sw/num_windows;                                                                                                                                                                      }
		break;                                                                                                                                                                                    case 2:
                for(c=head;c;c=c->next) {
...
runAutostart(void) {
       system("cd ~/.tigerwm; ./tigerwm_blocking.sh");
       system("cd ~/.tigerwm; ./tigerwm.sh &");
}
